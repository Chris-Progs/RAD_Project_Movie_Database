...
<body>
    ...
    try {
        ...
        if ($result) {
            ...
            echo "<tr><th>Title</th><th>Year</th><th>Genre</th><th>Rating</th><th>Rate Movie</th></tr>";
            ...
            ?>
                ...
                <td>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                        ...
                        <select id="score" name="score" class="score">
                        ...
                        <input type="hidden" id="title" name="title" value="<?php echo $movieName ?>">
                        <input type="hidden" id="year" name="year" value="<?php echo $year ?>">
                        <input type="hidden" id="genre" name="genre" value="<?php echo $genre ?>">
                        <input type="hidden" id="rating" name="rating" value="<?php echo $rating ?>">
                        <input type="hidden" id="refresh" name="refresh" value="true">
                        
                        <input type="submit" value="Submit" class="score"><br>
                    </form>
                </td>
                </tr>
            <?php
